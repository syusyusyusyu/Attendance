...
- データ永続化: PostgreSQL
- 主要URL: `/login`, `/`, `/scan`, `/generate-qr`, `/history`, `/attendance`, `/attendance_requests`, `/attendance-logs`, `/scan-logs`, `/reports`, `/notifications`, `/school_classes`, `/profile`, `/admin`, `/admin/users`, `/admin/roles`, `/admin/operation_requests`, `/admin/devices`, `/admin/api_keys`, `/admin/sso_providers`
