...
flowchart LR
  ...
  W --> C[Controller<br/>Sessions/Dashboard/QR/Attendance/ScanLogs/Profile]
  W --> S[Service<br/>AttendanceToken]
  W --> M[Model<br/>User/SchoolClass/Enrollment/AttendanceRecord/QrSession/QrScanEvent]
...
- 関連: enrollments, students, attendance_records, qr_sessions
...
#### AttendancePolicy
- 属性: school_class_id, late_after_minutes, close_after_minutes, allow_early_checkin
- 関連: school_class
